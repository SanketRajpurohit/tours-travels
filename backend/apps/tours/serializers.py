...
class HotelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Hotel
        fields = [
            'id', 'name', 'address', 'image', 'hotel_type', 
            'star_rating', 'is_active', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class CustomPackageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomPackage
        fields = [
            'id', 'customer', 'customer_email', 'contact_number', 'destination',
            'duration', 'start_date', 'participants_count', 'hotel_preference',
            'transportation_choice', 'package_type', 'special_requirements',
